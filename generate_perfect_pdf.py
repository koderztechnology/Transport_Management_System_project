...
<style>
    ...
    h2 { background-color: #f1f7ff; color: #004085; padding: 10px; border-left: 5px solid #0056b3; font-size: 14px; margin-top: 25px; margin-bottom: 5px;}
    .subtitle { color: #666; font-style: italic; font-size: 11px; margin-bottom: 10px; display: block; }
    table { width: 100%; border-collapse: collapse; margin-bottom: 20px; page-break-inside: auto; }
    tr { page-break-inside: avoid; page-break-after: auto; }
    th { background-color: #0056b3; color: white; padding: 8px; text-align: left; font-size: 12px; border: 1px solid #ddd; }
...
<h1>Database Roadmap - All 8 Tables</h1>
...
try:
    weasyprint.HTML(string=html_content).write_pdf('All_Tables_Roadmap_Fixed.pdf')
    print('Perfect PDF Generated!')
except Exception as e:
    print(f"Error generating PDF. Outputting HTML instead. Error: {e}")
    with open('All_Tables_Roadmap_Fixed.html', 'w') as fh:
